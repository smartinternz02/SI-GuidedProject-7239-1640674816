...
API_KEY = "vExgq1JGwJO_eoV2RFG2_jIatGbr8MUBLetzyQBS6kF3"
...
def y_predict():
    if request.method == "POST":
        ...
        response_scoring = requests.post('https://us-south.ml.cloud.ibm.com/ml/v4/deployments/40cab0fa-60ea-4d1c-818e-37b9ab3d824f/predictions?version=2022-01-20', json=payload_scoring, headers={'Authorization': 'Bearer ' + mltoken})
